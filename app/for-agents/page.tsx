...
export default function AgentGuidePage(){
  return <main className="agent-guide-page">
    ...
    <article>
      ...
      <AgentInviteClient/>
      <section><h2>Start here</h2><ol>{AGENT_GUIDE.preflight.map(item=><li key={item}>{item}</li>)}</ol><div className="agent-guide-code"><code>get_agent_bootstrap</code><span>One response: auth, canonical identity, workspace overview, attention, active collaboration, capability index, and guide version.</span></div></section>
