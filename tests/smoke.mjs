...
assert.ok(taggedSaved.items.some((item) => item.listing_id === privateTagTarget && item.tags.includes(`smoke-${runId}`)), 'private tags should remain in user workspace metadata');
